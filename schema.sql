...
CREATE TABLE "Salary" (
    ...
    "H_PCT10" FLOAT   NOT NULL,
    "H_PCT25" FLOAT   NOT NULL,
    "H_MEDIAN" FLOAT   NOT NULL,
    "H_PCT75" FLOAT   NOT NULL,
    "H_PCT90" FLOAT   NOT NULL,
    "A_PCT10" INT   NOT NULL,
    "A_PCT25" INT   NOT NULL,
    "A_MEDIAN" INT   NOT NULL,
    "A_PCT75" INT   NOT NULL,
    "A_PCT90" INT   NOT NULL,
    "ANNUAL" INT   NOT NULL,
    "HOURLY" INT   NOT NULL,
